...
HRESULT bossHPBar::init(int x, int y, int width, int height)
{
	_x = x;
	_y = y;
	_bossHPBarFront = IMAGEMANAGER->addImage("boss_HPBarFront", "image/boss/boss_HPBarFront.bmp", width, height, true, RGB(255, 0, 255));
	_bossHPBarBack = IMAGEMANAGER->addImage("boss_HPBarBack", "image/boss/boss_HPBarBack.bmp", width, height, true, RGB(255, 0, 255));

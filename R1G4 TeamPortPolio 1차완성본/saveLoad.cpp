...
void saveLoad::render()
{
	...
	if (tab[0].select&&tab[0].stageNum != NULL)tab[0].miniMapOn->render(getMemDC(), tab[0].rc.left + 7, tab[0].rc.top + 50);
	else if(tab[0].stageNum != NULL)tab[0].minimap->render(getMemDC(), tab[0].rc.left + 7, tab[0].rc.top + 50);
	if (tab[1].select&&tab[1].stageNum != NULL)tab[1].miniMapOn->render(getMemDC(), tab[1].rc.left + 7, tab[1].rc.top + 50);
	else if(tab[1].stageNum != NULL) tab[1].minimap->render(getMemDC(), tab[1].rc.left + 7, tab[1].rc.top + 50);
	if (tab[2].select&&tab[2].stageNum != NULL)tab[2].miniMapOn->render(getMemDC(), tab[2].rc.left + 7, tab[2].rc.top + 50);
	else if(tab[2].stageNum != NULL) tab[2].minimap->render(getMemDC(), tab[2].rc.left + 7, tab[2].rc.top + 50);

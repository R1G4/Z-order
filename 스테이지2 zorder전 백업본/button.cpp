...
HRESULT button::init(const char * imageName, float x, float y, POINT btnDownFramePoint, POINT btnUpFramePoint, CALLBACK_FUNCTION_ cbFunction)
{
	_callbackFunction = static_cast<CALLBACK_FUNCTION_>(cbFunction);

...
void animation::setDefPlayFrame(BOOL reverse, BOOL loop, CALLBACK_FUNCTION_ cbFunction)
{
	_obj = NULL;
...
void animation::setPlayFrame(int * playArr, int arrLen, BOOL loop, CALLBACK_FUNCTION_ cbFunction)
{
	_obj = NULL;
	_callbackFunction = cbFunction;
	_callbackFunctionParameter = NULL;
...
void animation::setPlayFrame(int start, int end, BOOL reverse, BOOL loop, CALLBACK_FUNCTION_ cbFunction)
{
	_obj = NULL;
	_callbackFunction = cbFunction;
	_callbackFunctionParameter = NULL;
